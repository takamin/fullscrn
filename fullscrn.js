(function() {
    ...
    var WebDLog = (function() {
        try { return require("./lib/web-dlog"); } catch(e) {/*ignore*/ }
    ...
    FullscreenAPI.request = function(element) {
        console.error("Waiting requestFullscreen implementation.");
    };
    ...
    FullscreenAPI.exit = function() {
        console.error("Waiting exitFullscreen implementation");
    };
